 ...
 */
(function initKeyboardShortcuts(global) {
  const ACTION_IDS = {
  ...
  function mergeShortcutBindings(saved) {
    /** @type {Record<string, { key: string, super: boolean, ctrl: boolean, alt: boolean, shift: boolean }>} */
    const out = {};
   ...
   */
  function findMatchingAction(e, merged, activeScreen) {
  ...
  function bindingToDisplayParts(b) {
  ...
  global.ShogunKeyboardShortcuts = {
    ACTION_IDS,
    DEFAULT_BINDINGS,
    ACTION_PRIORITY,
    CHAT_ONLY_ACTIONS,
