          ...
          <div style={{maxWidth:720, margin:'0 auto'}}>
            <div className="composer">
              ...
              <div className="row" style={{gap:8, marginTop:8, alignItems:'center'}}>
                <button className="btn btn-sm btn-ghost" type="button" style={{padding:'0 8px'}} onClick={openFilePicker} title="Attach files or images"><Icon name="paperclip" size={13}/>Attach</button>
