...
(function initShogunApi(global: any) {
  ...
  function createApi(client?: any) {
    ...
    return {
      ...
      aiFieldList: (input: any) => call("shogun_ai_field_list", input || {}, READ),
      aiFieldUpsert: (input: any) => call("shogun_ai_field_upsert", input, WRITE),
      contextActionList: (input: any) => call("shogun_context_action_list", input || {}, READ),
      contextActionAuditList: (input: any) => call("shogun_context_action_audit_list", input, READ),
      contextActionPropose: (input: any) => call("shogun_context_action_propose", input, WRITE),
      contextActionSetStatus: (input: any) => call("shogun_context_action_set_status", input, WRITE),
      contextActionExecute: (input: any) => call("shogun_context_action_execute", input, WRITE),
      scheduleQueueList: (input: any) => call("shogun_schedule_queue_list", input || {}, READ),
      crmUpdateQueueList: (input: any) => call("shogun_crm_update_queue_list", input || {}, READ),
      scheduleQueueRemove: (input: any) => call("shogun_schedule_queue_remove", input, WRITE),
      crmUpdateQueueRemove: (input: any) => call("shogun_crm_update_queue_remove", input, WRITE),
      scheduleQueueRetry: (input: any) => call("shogun_schedule_queue_retry", input, WRITE),
      crmUpdateQueueRetry: (input: any) => call("shogun_crm_update_queue_retry", input, WRITE),
      ...
      screenContextProbe: (input: any) => call("shogun_screen_context_probe", input || {}, READ),
      entityQuery: (input: any) => call("shogun_entity_query", input, READ),
      entityContextGet: (input: any) => call("shogun_entity_context_get", input, READ),
      contextSearch: (input: any) => call("shogun_context_search", input, READ),
      contextRecentGet: (input: any) => call("shogun_context_recent_get", input || {}, READ),
      contextTasksList: (input: any) => call("shogun_context_tasks_list", input || {}, READ),
      ownerContextSummaryGet: (input: any) => call("shogun_owner_context_summary", input, READ),
      ...
      appNavigate: (input: any) => call("app_navigate", input, WRITE),
      appOpenHummingbird: (input: any) => call("app_open_hummingbird", input, WRITE),
      hummingbirdContext: (input: any) => call("shogun_hummingbird_context", input || {}, READ),
      appCreateShareLink: (input: any) => call("app_create_share_link", input, WRITE),
      appNotificationStatus: (input: any) => call("app_notification_status", input || {}, READ),
      appNotificationRequest: (input: any) => call("app_notification_request", input || {}, WRITE),
      ...
      captureStatus: (input: any) => call("shogun_capture_status", input || {}, READ),
