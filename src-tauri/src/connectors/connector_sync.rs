...
use crate::{
    apple_local, claude, figma, github, gmail, google_drive, integration_secrets, integrations,
    linear, notion, outlook, settings_store, slack, zoom,
};
...
fn provider_settings(doc: &Value, provider: &str, default_mins: u64) -> (bool, u64, bool, u32) {
    let enabled = doc
        .pointer(&format!(
